...
// share them; these aliases keep the existing test bodies below unchanged.
typedef _FakeSafBackend = FakeSafBackend;
typedef _FakeSafUtil = FakeSafUtil;
typedef _FakeSafStream = FakeSafStream;
