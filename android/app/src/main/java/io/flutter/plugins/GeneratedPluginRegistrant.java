...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.fluttercavalry.saf_util.SafUtilPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin saf_util, com.fluttercavalry.saf_util.SafUtilPlugin", e);
    }
    try {
